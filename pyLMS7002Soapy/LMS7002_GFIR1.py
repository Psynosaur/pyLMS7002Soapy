# ***************************************************************
# * Name:      LMS7002_GFIR1.py
# * Purpose:   Class implementing LMS7002 GFIR1 functions
...
class LMS7002_GFIR1(LMS7002_base):
    ...
    def __init__(self, chip, RxTx, Channel):
        ...
        self.CMB0 = LMS7002_GFIR(chip, RxTx, Channel, 1, '0')
        self.CMB1 = LMS7002_GFIR(chip, RxTx, Channel, 1, '1')
        self.CMB2 = LMS7002_GFIR(chip, RxTx, Channel, 1, '2')
        self.CMB3 = LMS7002_GFIR(chip, RxTx, Channel, 1, '3')
        self.CMB4 = LMS7002_GFIR(chip, RxTx, Channel, 1, '4')
    ...
    def __repr__(self):
        ret = self.rxtx + "GFIR1 Channel " + self.channel + "\n"
